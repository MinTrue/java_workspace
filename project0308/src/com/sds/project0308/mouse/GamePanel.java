...
public class GamePanel extends JPanel{
	...
	public GamePanel() {
		...
		hero = new Hero("C:/java_workspace/project0308/res/plane.png", 100, 200, 60, 60, 1, 1);
		
/*------------------------------------------------------------------------------------------------*/		 
		/*클래스안에 또 다른 클래스를 정의하는 기법을 내부클래스라 하며
		 * 특히 이름이 없는 내부클래스 정의 기법을 내부 익명클래스라 한다.
		 * 클래스의 재사용성이 떨어질때, .java 까지 만들어야 하나.. 
		 * 1) 재사용 가능성이 별로 없는 클래스의 경우는 내부익명클래스로 많이 씀 주로 이벤트 구현시
...
/*---------------------------------------------------------------------------------------------------*/
	public void paint(Graphics g) {
		...
		hero.tick();
		hero.render(g);
		//g.drawImage(hero.image, 100, 200, 60, 60, this);
	}
}
