...
/*
 * 유지보수성을 높이기 위한 방법 이론인 MVC 패턴에 의하면,
 * 디자인 영역과, 데이터및 데이터를 제어하는 Model영역은 분리시켜 개발해야,
...
public class MyTableModel extends AbstractTableModel{
	...
	ArrayList<String[]> list = new ArrayList<String[]>(); //size 0 인 비어있는 리스트 생성
	
	String[] column = {"car_idx","name","price"};
	
	//TableModel 객체가 제공해주는 모든 메서드는 결국 View 단인 JTable 을 위한 메서드들이다.
	public int getRowCount() { //몇행인지
		return list.size();
	}

	public int getColumnCount() { // 몇열인지
