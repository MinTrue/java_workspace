...
/*
 * 컨트롤+ 쉬프트+ o 누르면 자동 import
 * 글자 클릭후 쉬프트 F2 누르면 api 문서로 바로이동
...
public class FlowLayoutTest {
	...
	public static void main(String[] args) {
		...
		frame.setLayout(flow); //이 시점 부터는 윈도우에 컴포넌트를 부착할때, 수직, 수평으로 흐르면서 부착됨
		for(int i=0;i<btn.length;i++) {
			frame.add(btn[i] = new Button(i+"btn"));
		}
		
		frame.setSize(300,400); //너비 300 높이 400
