...
/*
 * 자바의 UI 컴포넌트들을 화면 어디에 올려놓을지를 결정하려면 배치에 대해 학습해야한다.
 * java.awt 배치는 LayoutManager라 불리는 객체들로 지원됨
 * 
 * 배치의 유형
 * 1) BorderLayout : 동서남북 방위를 갖는 방식의배치
 * 2) GridLayout : 행과 열을 갖는 격자 방식의 배치
 * 3) FlowLayout : 수평 및 수직의 방향성으로 요소들을 흘르게 배치는 방식
 * 4) CardLayout : 여라장의 장면 중 누구를 보여줄지를 결정하는 배치방식, 오직 하니씩 보여줌
 * 							 카드놀이에서  카드와 동일
 * 5) GridBag : GridLayout을 좀더 세분화해여 배치하는 방식
 * */
...
public class LayoutTest {
	...
	public static void main(String[] args) {
		...
		//윈도우 창인 프레임이 지금부터는 BorderLayout 에 적용을 받는다/
		...
		//북쪽 영역에 컴포넌트 넣기
		//상수 - public static final 상순느 변수와 구분하기 위해 모두 대문자로 쓰는게 관례임
		...
		//이전 예제에서 우리가 아무런 배치관리자를 적용하지 않았기 때문에 초반에 대왕버튼이 CENTER로 
		//붙어있던 것이다
	}
